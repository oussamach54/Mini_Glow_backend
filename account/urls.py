...
from .views import (
    UserRegisterView, GoogleLoginView,
    CardsListView, UserAccountDetailsView, UserAccountUpdateView, UserAccountDeleteView,
    UserAddressesListView, CreateUserAddressView, UserAddressDetailsView, UpdateUserAddressView, DeleteUserAddressView,
    OrdersListView, ChangeOrderStatus,
    PasswordResetRequestView, PasswordResetConfirmView,
    CreateCODOrderView,
)

urlpatterns = [
    # auth (email/username + password is handled by /api/token/ at project level)
    path("login/", GoogleLoginView.as_view(), name="google_login"),   # keep if you use Google login alias
